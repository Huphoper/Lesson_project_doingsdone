...
<main class="content__main">
    ...
    <form class="form"  action="" method="post" enctype="multipart/form-data" autocomplete="off">
        <div class="form__row">
            ...
            <input class="form__input <?= in_array('101',$errors)? "form__input--error":"" ?>" type="text" name="name" id="name" value="" placeholder="Введите название">
    ...
    <?= in_array('102',$errors)? "<p class='form__message'>Поле не заполнено</p>":"" ?>
        ...
        <div class="form__row">
            ...
            <input class="form__input form__input--date <?= in_array('103',$errors)? "form__input--error":"" ?>" type="text" name="date" id="date" value="" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
        ...
        <div class="form__row">
            ...
            <?= in_array('104',$errors)? "<p class='form__message'>Превышен максимальный размер файла в 2МБ</p>":"" ?>
        </div>
